...
export type LinkRolesDropdownProps = {
  ...
  linkSelectedAccess: TOption | null;
  setLinkSelectedAccess: (access: TOption) => void;
};

export type LinkSettingsSubmitOption = TOption & {
  access?: number;
...
export type LinkSettingsActiveLink = {
  access?: ShareAccessRights | number;
  expirationDate?: string | null;
  id?: string;
  shareLink?: string;
  title?: string;
...
export type LinkSettingsPanelProps = {
  ...
  onSubmit: (item: LinkSettingsSubmitOption) => void;
  linkSelectedAccess: TOption | null;
  setLinkSelectedAccess: (access: TOption) => void;
  activeLink: LinkSettingsActiveLink;
  defaultAccess: ShareAccessRights | number;
  isContacts: boolean;
};
