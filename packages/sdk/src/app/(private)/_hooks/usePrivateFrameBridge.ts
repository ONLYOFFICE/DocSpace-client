...
export const sectionFromPathname = (pathname: string): PrivateFrameSection =>
  pathname.startsWith("/private/archive") ? "archive" : "rooms";

export const usePrivateFrameBridge = () => {
