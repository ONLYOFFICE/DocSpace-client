...
export const mockLocaleSamplePlugin: TAPIPlugin = {
  ...
  description: "Sample plugin demonstrating plugin localization",
  nameLocale: {
    de: "Locale-Beispiel",
    az: "Lokal nümunəsi",
  },
  descriptionLocale: {
    de: "Beispiel-Plugin zur Demonstration der Plugin-Lokalisierung",
    az: "Plagin lokalizasiyasını nümayiş etdirən nümunə plagin",
  },
...
export const mockContextMenuPlugin: TAPIPlugin = {
  ...
  version: "1.0.1",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating context menu integration",
...
export const mockInfoPanelPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating info panel integration",
...
export const mockSelectorPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating all selector types",
...
export const mockMainButtonPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating main button menu integration",
...
export const mockArticleButtonPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating article button sidebar integration",
...
export const mockFileItemPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating file item click interception",
...
export const mockProfileMenuPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating profile menu integration",
...
export const mockEventListenerPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating event listener integration",
...
export const mockMediaViewerPlugin: TAPIPlugin = {
  ...
  version: "1.0.0",
  minDocSpaceVersion: "3.5.0",
  description: "Sample plugin demonstrating media viewer integration",
...
export const mockApiPlugin: TAPIPlugin = {
  ...
  minDocSpaceVersion: "3.5.0",
  description:
    "Sample plugin demonstrating IApiPlugin usage — creates a room via the REST API",
...
export const mockCreateDialogPlugin: TAPIPlugin = {
  ...
  minDocSpaceVersion: "3.5.0",
  description:
    "Sample plugin demonstrating ICreateDialog usage — opens the native create-item dialog from a main-button item",
...
export const mockNavigationPlugin: TAPIPlugin = {
  ...
  minDocSpaceVersion: "3.5.0",
  description:
    "Sample plugin demonstrating Actions.navigate and Actions.openInfoPanel",
