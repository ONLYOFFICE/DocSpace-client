...
import type { TRoomTagsParams } from "@docspace/shared/utils/rooms";

class TagHandler {
  tags: TRoomTagsParams[];

  setTags: (newTags: TRoomTagsParams[]) => void;
