...
const SupportLinks: React.FC<SupportLinksProps> = ({
  ...
  const supportTeamDescription = (
    <Trans
      i18nKey="GotAnyProblems"
      ns="Settings"
      components={{
        1: (
          <Link
  ...
  const helpCenterDescription = (
    <Trans
      i18nKey="DetailedHelpCenter"
      ns="Settings"
      components={{
        1: (
          <Link
  ...
  if (feedbackAndSupportUrl && portalSettingsUrl) {
    return (
      <div className={styles.supportLinksContainer}>
        <Text className={styles.supportLinkText}>{supportTeamDescription}</Text>
        <Text className={styles.supportLinkText}>{helpCenterDescription}</Text>
      </div>
    );
  }
