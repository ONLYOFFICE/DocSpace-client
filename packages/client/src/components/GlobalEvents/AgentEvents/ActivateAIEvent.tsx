...
// Global "activate AI features" flow shown when an agent creation is requested
// (from any entry point) while AI is not active. On success useAIActivation
// re-dispatches AGENT_CREATE, so the create dialog opens once AI is ready.
const ActivateAIEvent = ({
  parentId,
  context,
  onClose,
  enableAIService,
