...
const DisableDialogComponent = ({ onClose, serverId }: DisableDialogProps) => {
  const { updateMCPStatus } = useAISettingsStore();
...
export const DisableMCPDialog = observer(DisableDialogComponent);
