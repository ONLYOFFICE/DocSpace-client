...
import ArchiveRoomFilesPage from "./page.client";
...
export default async function ArchiveRoomFiles({
  params,
  searchParams,
}: {
  ...
  try {
    ...
    throw new Error(
      `Failed to load archive room files data: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
