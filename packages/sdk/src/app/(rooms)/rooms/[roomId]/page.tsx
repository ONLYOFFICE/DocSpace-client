...
import RoomFilesPage from "./page.client";
...
export default async function RoomFiles({
  params,
  searchParams,
}: {
  ...
  try {
    ...
    throw new Error(
      `Failed to load room files data: ${error instanceof Error ? error.message : String(error)}`,
    );
  }
