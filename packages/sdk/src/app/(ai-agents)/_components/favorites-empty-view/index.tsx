...
// (title NoFavoritesHereYet + description EmptyFavoritesAgentsDescription
// + the EmptyFavorites icon set) — used by the /ai-agents/favorites body when the
...
const FavoritesEmptyView = () => {
  ...
  return (
    <EmptyView
      ...
      description={t("Common:EmptyFavoritesAgentsDescription", {
        defaultValue: "Star files generated by AI agents for quick access.",
      })}
      options={null}
    />
  );
