...
const EditMCPDialogComponent = ({ server, onClose }: EditDialogProps) => {
  const { updateMCP } = useAISettingsStore();
...
export const EditMCPDialog = observer(EditMCPDialogComponent);
