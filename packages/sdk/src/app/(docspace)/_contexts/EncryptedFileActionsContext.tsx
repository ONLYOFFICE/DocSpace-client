...
export const EncryptedFileActionsContext =
  React.createContext<EncryptedFileActions | null>(null);

export const useEncryptedFileActions = () =>
  React.useContext(EncryptedFileActionsContext);

export type { TFileItem, TFolderItem };
