...
import FileTileContent from "../file-tile/sub-components/file-tile-content/FileTileContent";
...
export const Active: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Room tile in active state",
      },
    },
  },
};
...
export const ThirdParty: Story = {
  ...
  args: {
    ...
    item: {
      ...
      thirdPartyIcon: PublicRoomIconReactSvgUrl,
    },
  },
  parameters: {
    docs: {
      description: {
        story: "Room tile with third-party integration",
      },
    },
  },
};
...
export const WithCustomTags: Story = {
  ...
  parameters: {
    docs: {
      description: {
        story: "Room tile with custom tags",
      },
    },
  },
};
