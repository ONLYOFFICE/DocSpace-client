...
const AIProviderComponent = () => {
  ...
  const aiConfig = aiConfigStore.aiConfig;
  // settingsStore.aiProviderSettingsUrl has no SDK equivalent — skip the
  // "Learn more" link entirely in the SDK iframe context.
  const aiProviderSettingsUrl: string | undefined = undefined;
...
export const AIProvider = observer(AIProviderComponent);
