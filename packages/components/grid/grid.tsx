...
// @ts-expect-error TS(2339): Property 'tag' does not exist on type '{}'.
...
Grid.propTypes = {
  ...
  // @ts-expect-error TS(2322): Type '{ as: PropTypes.Requireable<string>; alignCo... Remove this comment to see the full error message
  as: PropTypes.string,
...
Grid.defaultProps = {
  // @ts-expect-error TS(2322): Type '{ heightProp: string; widthProp: string; }' ... Remove this comment to see the full error message
  heightProp: "100%",
  widthProp: "100%",
};
