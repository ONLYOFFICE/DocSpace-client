...
const weekdaysLabelArray: TOption[] = [
  { key: 0, label: "Monday" },
  { key: 1, label: "Tuesday" },
...
const monthNumbersArray: TOption[] = Array(31)
  .fill(null)
  .map((_, index) => ({
    key: index + 1,
    label: `${index + 1}`,
...
const hoursArray: TOption[] = Array(24)
  .fill(null)
  .map((_, index) => ({
    key: index,
    label: `${index}:00`,
...
const maxNumberCopiesArray: TOption[] = [
