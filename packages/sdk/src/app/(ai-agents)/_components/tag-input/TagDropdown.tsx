...
import type { TagDropDownProps } from "./TagInput.types";
...
const TagDropdown = ({
  ...
  const onKeyPress = React.useCallback(
    ...
    // addNewTag is recreated on every render, mirror client behavior — the
    // listener resubscribes alongside it so latest input value is captured.
