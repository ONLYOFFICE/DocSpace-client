...
const CreateAgentDialog = ({
  ...
  // Track mount state so the post-create reset in onCreateAgent doesn't
  // touch state after unmount. Empty deps — the client original omits
  // them, but that fires the cleanup on every render and sets the ref to
  // false prematurely; the SDK port fixes the regression.
  React.useEffect(() => {
    return () => {
