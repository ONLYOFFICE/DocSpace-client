...
const DeleteDialogComponent = ({ onClose, serverId }: DeleteDialogProps) => {
  const { deleteMCP } = useAISettingsStore();
...
export const DeleteMCPDialog = observer(DeleteDialogComponent);
