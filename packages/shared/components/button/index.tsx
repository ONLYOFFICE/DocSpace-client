...
const Button = React.forwardRef((props, ref) => {
  ...
  return (
    // @ts-expect-error TS(2322): Type '{ children: any[]; innerRef: ForwardedRef<un... Remove this comment to see the full error message
    <ColorTheme {...props} innerRef={ref} themeId={ThemeType.Button}>
      {isLoading && (
        <Loader
          ...
          type="track"
          label={label}
          // @ts-expect-error TS(2322): Type '{ className: string; size: string; type: str... Remove this comment to see the full error message
          primary={primary}
        />
      )}
...
Button.propTypes = {
  /** Button text */
  // @ts-expect-error TS(2322): Type '{ label: PropTypes.Requireable<string>; prim... Remove this comment to see the full error message
