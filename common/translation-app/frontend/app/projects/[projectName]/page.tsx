...
export default function ProjectPage() {
  ...
  const isLoading = projectLoading || languagesLoading || 
                    namespacesLoading || translationsLoading;
  
  // Determine if there's an error
  const error = projectError || languagesError || 
                namespacesError || translationsError;
        ...
        <div className="lg:col-span-3">
          <div className="card">
            <h2 className="text-lg font-semibold mb-4">
              {currentNamespace ? `Translations: ${currentNamespace}` : 'Select a namespace'}
            </h2>
