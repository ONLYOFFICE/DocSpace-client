...
const StyledChipWithInput = styled.div`
  ...
  height: fit-content;
  cursor: auto;
  // @ts-expect-error TS(2339): Property 'length' does not exist on type 'ThemedSt... Remove this comment to see the full error message
...
const StyledChip = styled.div`
  ...
  background: ${(props) =>
    // @ts-expect-error TS(2339): Property 'isValid' does not exist on type 'ThemedS... Remove this comment to see the full error message
