...
const FigmaReferenceModal: React.FC<FigmaReferenceModalProps> = ({
  ...
  const [searchProgress, setSearchProgress] =
    useState<SearchProgressInfo | null>(null);
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const results = await searchProjectForText(
        translationValue,
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Figma Reference Search">
      <div
      ...
      >
        <div className="bg-gray-100 dark:bg-gray-700 p-3 rounded-md">
          ...
          <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mt-3 mb-1">
            English Value
          </h3>
                ...
                <div className="w-full max-w-md">
                  <div className="text-xs text-gray-500 dark:text-gray-400 mb-2">
                      ...
                      <span>
                        {searchProgress.currentFile && (
                          <span className="font-medium">
                            File:{" "}
                            {searchProgress.currentFile.length > 30
                    ...
                    <div className="text-xs italic text-right">
                      Searched files: {searchProgress.currentFileIndex + 1} of{" "}
                      {searchProgress.totalFiles}
                    </div>
                  </div>
                  ...
                  <div className="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-2.5">
                    <div
                      ...
                      style={{
                        width: `${Math.min(
                          100,
                          ((searchProgress.currentFileIndex + 0.5) /
                            Math.max(1, searchProgress.totalFiles)) *
                            100
                        )}%`,
                      }}
                  ...
                  <div className="text-xs text-gray-500 dark:text-gray-400 mt-2 flex justify-between">
                    ...
                    {searchProgress.matchesFound > 0 && (
                      <span className="text-green-600 dark:text-green-400 font-medium">
                        Found {searchProgress.matchesFound} match
                        {searchProgress.matchesFound !== 1 ? "es" : ""}
                      </span>
                    )}
                  </div>
                </div>
              ...
              {searchResults.length > 0 && (
                <div className="mb-4">
                  <h3 className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">
                    ...
                    {searchResults.length !== 1 ? "es" : ""} in Figma
                  ...
                  <div
                    ...
                    style={{
                      maxHeight: searchResults.length > 6 ? "150px" : "auto",
                      overflowY: "auto",
                    }}
                  >
                        ...
                        {selectedResult.projectName && (
                          <span
                            className={`ml-2 text-sm px-2 py-0.5 rounded ${
                              selectedResult.projectName === "UI Kit"
                                ? "bg-purple-100 dark:bg-purple-900/30 text-purple-800 dark:text-purple-300 font-medium"
                                : "bg-blue-100 dark:bg-blue-900/30 text-blue-800 dark:text-blue-300"
                            }`}
                          >
