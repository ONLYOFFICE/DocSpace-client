...
const AccessRightSelect = ({
  ...
  const onSelectCurrentItem = useCallback(
    (e: any) => {
      ...
      const item = accessOptions.find((el: any) => {
        return el.key === key;
      });
  ...
  const formatToAccessRightItem = (data: any) => {
              ...
              <StyledItemTitle>
                ...
                {item.quota && (
                  <Badge
                    ...
                    fontSize="9px"
                    // @ts-expect-error TS(2322): Type '{ label: any; backgroundColor: any; fontSize... Remove this comment to see the full error message
                    isPaidBadge
                  />
                )}
              </StyledItemTitle>
