...
const meta = {
  title: "Pages/AutoBackup/Storages/RackspaceStorage",
  component: RackspaceStorage,
  parameters: {
    docs: {
      description: {
        component: "Rackspace storage configuration for Auto Backup",
      },
    },
  },
  args: {
...
} satisfies Meta<typeof RackspaceStorage>;
