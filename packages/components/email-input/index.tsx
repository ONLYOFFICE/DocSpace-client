...
class EmailInput extends React.Component {
  ...
  checkEmail = (value: any) => {
    // @ts-expect-error TS(2339): Property 'customValidate' does not exist on type '... Remove this comment to see the full error message
    ...
    if (customValidate) {
      ...
      const errors = parsedErrors
        ? parsedErrors.map((error: any) => error.errorKey)
        : [];
      return {
        value,
  ...
  render() {
    ...
    // @ts-expect-error TS(2339): Property 'isValidEmail' does not exist on type 'Re... Remove this comment to see the full error message
