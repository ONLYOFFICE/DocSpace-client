...
interface WithExternalLinkProps extends React.HTMLAttributes<HTMLDivElement> {
  withoutExternalLink?: boolean;
}
...
export const StyledCategoryWrapper = ({
  className,
  children,
  ...props
...
export const StyledBruteForceProtection = ({
  withoutExternalLink,
  className,
  children,
  ...props
