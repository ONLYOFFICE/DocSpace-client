  ...
  .table-container_group-menu-checkbox {
    ${(props) =>
      props.theme.interfaceDirection === "rtl"
        ? `
        margin-right: 28px;
        // @ts-expect-error TS(2339): Property 'checkboxMargin' does not exist on type '... Remove this comment to see the full error message
...
const StyledInfoPanelToggleColorThemeWrapper = styled(ColorTheme)`
  ...
  ${(props) =>
    // @ts-expect-error TS(2339): Property 'isInfoPanelVisible' does not exist on ty... Remove this comment to see the full error message
...
const StyledTableHeaderCell = styled.div`
  cursor: ${(props) =>
    // @ts-expect-error TS(2339): Property 'showIcon' does not exist on type 'Themed... Remove this comment to see the full error message
  ...
  .header-container-text-icon {
    ...
    ${(props) =>
      // @ts-expect-error TS(2339): Property 'sorted' does not exist on type 'ThemedSt... Remove this comment to see the full error message
      props.sorted &&
      css`
        transform: scale(1, -1);
...
const StyledTableCell = styled.div`
  ...
  .table-container_element {
    // @ts-expect-error TS(2339): Property 'checked' does not exist on type 'ThemedS... Remove this comment to see the full error message
  ...
  ${(props) =>
    // @ts-expect-error TS(2339): Property 'hasAccess' does not exist on type 'Theme... Remove this comment to see the full error message
    props.hasAccess &&
    css`
      :hover {
        .table-container_element {
