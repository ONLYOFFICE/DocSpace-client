...
const SessionsLoader = ({ viewAs }: SessionsProps) => {
  return (
    <StyledLoader>
      <div className="header">
        <RectangleSkeleton className="title" height="72px" />
      </div>

      <div className="content">
        {viewAs === "table" ? (
          <TableSkeleton style={{ display: "inline-flex" }} />
        ) : (
          <RowsSkeleton style={{ display: "inline-flex" }} />
        )}
      </div>
    </StyledLoader>
  );
