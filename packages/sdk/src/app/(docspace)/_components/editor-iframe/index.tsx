...
import styles from "./EditorIframe.module.scss";

type EditorIframeProps = {
  /**
   * Path on the editor origin (including query string), e.g.
   * "/doceditor?fileId=123" or "/doceditor/create?parentId=...".
   */
  path: string;
  /** Called when the editor signals it should be closed. */
  onClose: () => void;
