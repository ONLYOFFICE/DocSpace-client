...
const meta = {
  title: "Pages/AutoBackup/Storages/SelectelStorage",
  component: SelectelStorage,
  parameters: {
    docs: {
      description: {
        component: "Selectel storage configuration for Auto Backup",
      },
    },
  },
  args: {
...
} satisfies Meta<typeof SelectelStorage>;
