...
import styles from "./loaderAdditionalResources.module.scss";
    ...
    <div className={styles.loader}>
      <div className={styles.item}>
        <RectangleSkeleton
          width="166px"
          height="22px"
          className={styles.loaderHeader}
        />
      </div>

      <div className={styles.item}>
        <RectangleSkeleton width="700px" height="20px" />
      </div>
      ...
      <div className={styles.button}>
        <RectangleSkeleton width="86px" height="32px" className={styles.save} />
