...
export const ENCRYPTION_CONSTANTS = {
  ...
  AES_CBC_IV_SIZE: 16,
  SALT_SIZE: 16,
  SESSION_CACHE_DURATION_MS: 30 * 60 * 1000,
  CHUNKED_MAGIC: new Uint8Array([0x44, 0x53, 0x45, 0x32]),
  CHUNKED_HEADER_SIZE: 12,
  CHUNK_PLAINTEXT_SIZE: 1 * 1024 * 1024,
  CHUNKED_ENCRYPTION_THRESHOLD: 5 * 1024 * 1024,
} as const;
