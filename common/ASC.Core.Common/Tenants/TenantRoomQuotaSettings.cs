...
[Serializable]
public class TenantRoomQuotaSettings : ISettings<TenantRoomQuotaSettings>
{
    public bool EnableRoomQuota { get; set; }

    public long DefaultRoomQuota { get; set; }
