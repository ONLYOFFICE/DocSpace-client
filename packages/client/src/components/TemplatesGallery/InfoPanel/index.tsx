...
const InfoPanelTemplateGallery = ({
  ...
  return (
    <InfoPanel
      isVisible={isVisibleInfoPanelTemplateGallery}
      onClose={onClose}
      topInfoPanel
      canDisplay
    >
      <SubInfoPanelHeader>
        <InfoPanelHeaderContent isGallery onClose={onClose} />
      </SubInfoPanelHeader>
      <SubInfoPanelBody>
...
})(observer(InfoPanelTemplateGallery));
