...
const rowContent = (
  <>
    // @ts-expect-error TS(2322): Type '{ children: Element; contextOptions: { key: ... Remove this comment to see the full error message
    <Row
      key="1"
      {...checkedProps}
      {...elementProps}
  ...
  >
    <div style={{ justifySelf: "center" }}>
      ...
      <div style={{ padding: "24px 0 8px 0" }}>
        ...
        <Tooltip
          ...
          getContent={({ content }) =>
            content ? (
              <div>
                // @ts-expect-error TS(2322): Type '{ children: string; isBold: true; fontSize: ... Remove this comment to see the full error message
                <Text isBold={true} fontSize="16px">
                  {arrayUsers[content].name}
                </Text>
                // @ts-expect-error TS(2322): Type '{ children: string; color: string; fontSize:... Remove this comment to see the full error message
      ...
      <div style={{ padding: "8px 0" }}>
        <Toast />
        <Button
          // @ts-expect-error TS(2322): Type '{ label: string; onClick: () => ReactText; }... Remove this comment to see the full error message
          label="Show toastr"
          onClick={() =>
    ...
    <div style={{ justifySelf: "center" }}>
      ...
      <div style={{ padding: "8px 0" }}>
        <StringValue>
          {({
            ...
            // @ts-expect-error TS(2322): Type '{ children: Element; placeholder: string; ic... Remove this comment to see the full error message
            <InputBlock
              placeholder="Add input text"
      ...
      <div style={{ padding: "8px 0" }}>
        <StringValue>
          {({
            ...
            // @ts-expect-error TS(2322): Type '{ children: Element; place: string; isRequir... Remove this comment to see the full error message
            <FieldContainer
              place="top"
              isRequired
      ...
      <div style={{ padding: "8px 0" }}>
        <RadioButtonGroup
          // @ts-expect-error TS(2322): Type '{ name: string; selected: string; options: (... Remove this comment to see the full error message
          name="fruits"
          selected="banana"
          options={[
            ...
            <div style={{ display: "flex" }}>
              <div style={{ marginRight: 24 }}>
                <Checkbox
                  ...
                  isDisabled={false}
                  onChange={(e: any) => toggle(e.target.checked)}
                />
              </div>
              <Checkbox
                id="id"
      ...
      <div style={{ padding: "8px 0 24px 0" }}>
        <BooleanValue>
          {({
            ...
            <ToggleButton
              // @ts-expect-error TS(2322): Type '{ label: string; onChange: (e: any) => any; ... Remove this comment to see the full error message
              label="Toggle button"
              onChange={(e: any) => toggle(e.target.checked)}
              isChecked={value}
            />
    ...
    <div style={{ justifySelf: "center" }}>
      <div style={{ padding: "8px 0" }}>
        <Calendar
          onChange={() => {}}
          // @ts-expect-error TS(2322): Type '{ onChange: () => void; disabled: boolean; t... Remove this comment to see the full error message
          disabled={false}
          themeColor="#ED7309"
          selectedDate={new Date()}
          openToDate={new Date()}
    ...
    <div>
      ...
      <div style={{ padding: "16px 0" }}>
        // @ts-expect-error TS(2322): Type '{ children: Element; label: string; }' is no... Remove this comment to see the full error message
