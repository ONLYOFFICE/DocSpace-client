...
const SaasDefaultProviderComponent = ({
  aiConfig,
  aiProviders,
...
export const SaasDefaultProvider = inject(
...
)(observer(SaasDefaultProviderComponent));
