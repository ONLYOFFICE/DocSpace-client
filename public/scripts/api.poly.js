...
(function () {
  ...
  var getConfigFromParams = function getConfigFromParams() {
    ...
    if (searchUrl && searchUrl.length) {
      object = JSON.parse(
        '{"'.concat(searchUrl.replace(/&/g, '","').replace(/=/g, '":"'), '"}'),
        function (k, v) {
          ...
          switch (config.mode) {
            case "manager": {
              if (config.filter) {
                ...
                var filterString = new URLSearchParams(
                  config.filter
                ).toString();
                path = ""
                  .concat(config.rootPath)
                  .concat(config.id ? config.id + "/" : "", "filter?")
                  .concat(filterString);
              }
              break;
            }
            ...
            case "file-selector": {
              path = "/sdk/file-selector?selectorType=".concat(
                config.selectorType
              );
              break;
            }
            ...
            case "editor": {
              ...
              path = "/doceditor/?fileId="
                .concat(config.id, "&type=")
                .concat(config.editorType, "&editorGoBack=")
                .concat(goBack);
              break;
            }
            case "viewer": {
              ...
              path = "/doceditor/?fileId="
                .concat(config.id, "&type=")
                .concat(config.editorType, "&action=view&editorGoBack=")
                .concat(_goBack);
              break;
            }
            default:
      ...
      _classPrivateFieldInitSpec(this, _sendMessage, {
        ...
        value: function value(message) {
          ...
          if (!!_classPrivateFieldGet(_this, _iframe).contentWindow) {
            _classPrivateFieldGet(_this, _iframe).contentWindow.postMessage(
              JSON.stringify(mes, function (key, value) {
            ...
            switch (data.type) {
              case "onMethodReturn": {
                ...
                if (_classPrivateFieldGet(_this, _tasks).length > 0) {
                  _classPrivateFieldGet(_this, _sendMessage).call(
                    _this,
                    _classPrivateFieldGet(_this, _tasks).shift()
                  );
                }
                break;
              }
              case "onEventReturn": {
                ...
                if (
                  ((_data = data) === null ||
                  _data === void 0 ||
                  (_data = _data.eventReturnData) === null ||
                  _data === void 0
                    ? void 0
                    : _data.event) in _this.config.events &&
                  typeof _this.config.events[
                    (_data2 = data) === null || _data2 === void 0
                      ? void 0
                      : _data2.eventReturnData.event
                  ] === "function"
                ) {
                  var _data3, _data4;
                  _this.config.events[
                    (_data3 = data) === null || _data3 === void 0
                      ? void 0
                      : _data3.eventReturnData.event
                  ](
                    (_data4 = data) === null ||
                      _data4 === void 0 ||
                      (_data4 = _data4.eventReturnData) === null ||
                      _data4 === void 0
                      ? void 0
                      : _data4.data
                  );
        ...
        value: function value(methodName) {
          ...
          return new Promise(function (resolve) {
            if (withReload) {
              ...
              _classPrivateFieldGet(_this, _executeMethod).call(
                _this,
                methodName,
                params,
                function (data) {
    ...
    _createClass(DocSpace, [
        ...
        value: function initFrame(config) {
          ...
          if (target) {
            _classPrivateFieldSet(
              this,
              _iframe,
              _classPrivateFieldGet(this, _createIframe).call(this, this.config)
            );
            _classPrivateFieldSet(this, _classNames, target.className);
            target.parentNode &&
              target.parentNode.replaceChild(
                _classPrivateFieldGet(this, _iframe),
                target
              );
            window.addEventListener(
              "message",
              _classPrivateFieldGet(this, _onMessage),
              false
            );
      ...
      },
      {
        ...
        value: function destroyFrame() {
          ...
          if (_classPrivateFieldGet(this, _iframe)) {
            ...
            _classPrivateFieldGet(this, _iframe).parentNode &&
              _classPrivateFieldGet(this, _iframe).parentNode.replaceChild(
                target,
                _classPrivateFieldGet(this, _iframe)
              );
          }
      ...
      },
      {
        ...
        value: function getFolderInfo() {
          return _classPrivateFieldGet(this, _getMethodPromise).call(
            this,
            "getFolderInfo"
          );
        },
        ...
        value: function setConfig() {
          ...
          var reload =
            arguments.length > 1 && arguments[1] !== undefined
              ...
              : false;
          if (
            _classPrivateFieldGet(this, _oneOfExistInObject).call(
              this,
              this.config.keysForReload,
              newConfig
            )
          )
            reload = true;
