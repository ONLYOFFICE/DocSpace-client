...
// don't exist in the SDK route group, so this build forwards straight to
// the ui-kit AIAgent selector.
...
const AiAgentsDialog = (props: Props) => {
  return <AIAgentsSelector {...props} />;
};

export default AiAgentsDialog;
