...
import styles from "./trusted-mail-loader.module.scss";

const TrustedMailLoader = () => {
  return (
    <div className={styles.loader}>
      <RectangleSkeleton className={styles.header} height="37px" />
      <RectangleSkeleton className={styles.description} height="100px" />
      ...
      <div className={styles.inputs}>
        ...
        <RectangleSkeleton className={styles.add} height="20px" />
      </div>
